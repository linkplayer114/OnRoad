...
GetMessages$Query$Order$OrderMessage
    _$GetMessages$Query$Order$OrderMessageFromJson(Map<String, dynamic> json) =>
        GetMessages$Query$Order$OrderMessage()
          ...
          ..sentAt = fromGraphQLTimestampToDartDateTime(json['sentAt']);
...
Map<String, dynamic> _$GetMessages$Query$Order$OrderMessageToJson(
    ...
    <String, dynamic>{
      ...
      'sentAt': fromDartDateTimeToGraphQLTimestamp(instance.sentAt),
    };
...
GetMessages$Query$Order _$GetMessages$Query$OrderFromJson(
    ...
    GetMessages$Query$Order()
      ...
      ..rider = json['rider'] == null
          ? null
          : GetMessages$Query$Order$Rider.fromJson(
...
UpdateLastSeenMessagesAt$Mutation _$UpdateLastSeenMessagesAt$MutationFromJson(
        Map<String, dynamic> json) =>
    UpdateLastSeenMessagesAt$Mutation()
      ..updateLastSeenMessagesAt = json['updateLastSeenMessagesAt'] as bool;

Map<String, dynamic> _$UpdateLastSeenMessagesAt$MutationToJson(
        UpdateLastSeenMessagesAt$Mutation instance) =>
    <String, dynamic>{
      'updateLastSeenMessagesAt': instance.updateLastSeenMessagesAt,
    };
...
Reservations$Query$OrderConnection$OrderEdge$Order
    _$Reservations$Query$OrderConnection$OrderEdge$OrderFromJson(
        ...
        Reservations$Query$OrderConnection$OrderEdge$Order()
          ..id = json['id'] as String
          ..expectedTimestamp =
              fromGraphQLTimestampToDartDateTime(json['expectedTimestamp'])
...
GetAnnouncements$Query$AnnouncementConnection$AnnouncementEdge$Announcement
    _$GetAnnouncements$Query$AnnouncementConnection$AnnouncementEdge$AnnouncementFromJson(
        ...
        GetAnnouncements$Query$AnnouncementConnection$AnnouncementEdge$Announcement()
          ...
          ..startAt = fromGraphQLTimestampToDartDateTime(json['startAt'])
...
HistoryOrderItemMixin$OrderEdge$Order
    _$HistoryOrderItemMixin$OrderEdge$OrderFromJson(
        ...
        HistoryOrderItemMixin$OrderEdge$Order()
          ...
          ..createdOn = fromGraphQLTimestampToDartDateTime(json['createdOn'])
          ..addresses = (json['addresses'] as List<dynamic>)
              .map((e) => e as String)
              .toList()
          ...
          ..service = json['service'] == null
              ? null
              : HistoryOrderItemMixin$OrderEdge$Order$Service.fromJson(
...
GetOrderDetails$Query$Order _$GetOrderDetails$Query$OrderFromJson(
    ...
    GetOrderDetails$Query$Order()
      ...
      ..service = json['service'] == null
          ? null
          : GetOrderDetails$Query$Order$Service.fromJson(
              json['service'] as Map<String, dynamic>)
...
Wallet$Query$RiderTransacionConnection$RiderTransacionEdge$RiderTransacion
    _$Wallet$Query$RiderTransacionConnection$RiderTransacionEdge$RiderTransacionFromJson(
            Map<String, dynamic> json) =>
        Wallet$Query$RiderTransacionConnection$RiderTransacionEdge$RiderTransacion()
          ..createdAt = fromGraphQLTimestampToDartDateTime(json['createdAt'])
...
GetCurrentOrder$Query$Rider$Order _$GetCurrentOrder$Query$Rider$OrderFromJson(
    ...
    GetCurrentOrder$Query$Rider$Order()
      ...
      ..service = json['service'] == null
          ? null
          : CurrentOrderMixin$Service.fromJson(
              json['service'] as Map<String, dynamic>)
      ...
      ..riderLastSeenMessagesAt =
          fromGraphQLTimestampToDartDateTime(json['riderLastSeenMessagesAt'])
      ..conversations = (json['conversations'] as List<dynamic>)
          .map((e) => CurrentOrderMixin$OrderMessage.fromJson(
              e as Map<String, dynamic>))
          .toList();
...
Map<String, dynamic> _$GetCurrentOrder$Query$Rider$OrderToJson(
  ...
  val['riderLastSeenMessagesAt'] =
      fromDartDateTimeToGraphQLTimestamp(instance.riderLastSeenMessagesAt);
  val['conversations'] = instance.conversations.map((e) => e.toJson()).toList();
  return val;
}
...
CurrentOrderMixin$OrderMessage _$CurrentOrderMixin$OrderMessageFromJson(
        Map<String, dynamic> json) =>
    CurrentOrderMixin$OrderMessage()
      ..sentAt = fromGraphQLTimestampToDartDateTime(json['sentAt']);

Map<String, dynamic> _$CurrentOrderMixin$OrderMessageToJson(
        CurrentOrderMixin$OrderMessage instance) =>
    <String, dynamic>{
      'sentAt': fromDartDateTimeToGraphQLTimestamp(instance.sentAt),
    };
...
UpdatedOrder$Subscription$Order$OrderMessage
    _$UpdatedOrder$Subscription$Order$OrderMessageFromJson(
            Map<String, dynamic> json) =>
        UpdatedOrder$Subscription$Order$OrderMessage()
          ..sentAt = fromGraphQLTimestampToDartDateTime(json['sentAt']);

Map<String, dynamic> _$UpdatedOrder$Subscription$Order$OrderMessageToJson(
        UpdatedOrder$Subscription$Order$OrderMessage instance) =>
    <String, dynamic>{
      'sentAt': fromDartDateTimeToGraphQLTimestamp(instance.sentAt),
    };
...
UpdatedOrder$Subscription$Order _$UpdatedOrder$Subscription$OrderFromJson(
    ...
    UpdatedOrder$Subscription$Order()
      ...
      ..riderLastSeenMessagesAt =
          fromGraphQLTimestampToDartDateTime(json['riderLastSeenMessagesAt'])
      ..conversations = (json['conversations'] as List<dynamic>)
          .map((e) => UpdatedOrder$Subscription$Order$OrderMessage.fromJson(
              e as Map<String, dynamic>))
          .toList()
      ..points = (json['points'] as List<dynamic>)
      ...
      ..service = json['service'] == null
          ? null
          : UpdatedOrder$Subscription$Order$Service.fromJson(
              json['service'] as Map<String, dynamic>);
...
UpdateLastSeenMessagesAtArguments _$UpdateLastSeenMessagesAtArgumentsFromJson(
        Map<String, dynamic> json) =>
    UpdateLastSeenMessagesAtArguments(
      requestId: json['requestId'] as String,
    );

Map<String, dynamic> _$UpdateLastSeenMessagesAtArgumentsToJson(
        UpdateLastSeenMessagesAtArguments instance) =>
    <String, dynamic>{
      'requestId': instance.requestId,
    };
