        ...
        children: [
          ...
          Flexible(
            ...
            children: [
              ...
              if (driver?.status == Enum$DriverStatus.WaitingDocuments)
                Center(
                  child: WaitingToCompleteSubmissionUnregisteredView(
                      refetch: refetch),
                ),
              if (driver?.status == Enum$DriverStatus.PendingApproval)
                Center(
                    child: RegistrationSubmittedUnregisteredView(
                        refetch: refetch)),
              if (driver?.status == Enum$DriverStatus.SoftReject)
                Center(
        ...
        Container(
          ...
          child: Column(
            children: [
              ...
              if (rejectionNote?.isNotEmpty ?? false)
                Text(
                  rejectionNote ?? "",
                  textAlign: TextAlign.center,
                  style: Theme.of(context)
